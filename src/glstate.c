...
static const state_info program_state[] =
{
    ...
    { "Attached", GL_NONE, TYPE_6GLuint, 0, -1, "2.0", STATE_ATTACHED_SHADERS },
...
/* FIXME: if we have GL_VERSION_2_0 but not GL_ARB_shader_objects, then
 * the enums below may not be defined.
 */
...
#endif /* GL_VERSION_2_0 || GL_ARB_shader_objects */
...
static void spawn_children_tex_level_parameter(const glstate *self, bugle_linked_list *children)
{
    ...
    /* FIXME: check if bugle_begin_internal_render is reentrant */
#ifdef GL_ARB_texture_compression
