...
static const state_info global_state[] =
{
    ...
    { STATE_NAME(GL_DRAW_BUFFER), TYPE_6GLenum, -1, GL_VERSION_1_1, BUGLE_EXTGROUP_no_draw_buffer, STATE_GLOBAL },
...
{
#ifdef GL_EXT_framebuffer_object
    { STATE_NAME(GL_DRAW_BUFFER), TYPE_6GLenum, -1, BUGLE_GL_EXT_framebuffer_object, BUGLE_EXTGROUP_no_draw_buffer, STATE_FRAMEBUFFER_PARAMETER },
    { STATE_NAME(GL_READ_BUFFER), TYPE_6GLenum, -1, BUGLE_GL_EXT_framebuffer_object, -1, STATE_FRAMEBUFFER_PARAMETER },
#endif
    { NULL, GL_NONE, NULL_TYPE, 0, -1, -1, 0 }
};
