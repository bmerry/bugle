...
#define RESP_STATE        0xabcd0003L
#define RESP_ERROR        0xabcd0004L

#define REQ_CONT          0xdcba0000L
#define REQ_BREAK         0xdcba0001L
#define REQ_BREAK_ERROR   0xdcba0002L
#define REQ_STATE         0xdcba0003L
#define REQ_QUIT          0xdcba0004L
